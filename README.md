...
**NYTReader** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
Here's a walkthrough of implemented user stories: http://i.imgur.com/Nca006J.gif

<img src='http://i.imgur.com/Nca006J.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
